export type DebugSnapshot = {
  ...
  motion: string; animation: string; animationTime: number; loaded: boolean; focused: boolean;
...
export const emptySnapshot: DebugSnapshot = {
  fps: 0, frameMs: 0, x: 0, y: 0, z: 0, yaw: 0, motion: 'idle', animation: '—', animationTime: 0,
