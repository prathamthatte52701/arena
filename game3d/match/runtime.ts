...
export type MatchSnapshot = {
  ...
  loaded: boolean; grounded: boolean; drawCalls: number; triangles: number; playerHealth: number; cpuHealth: number; playerStamina: number; cpuStamina: number; playerMomentum: number; cpuMomentum: number; playerCombat: string; cpuCombat: string; combatEvent: string; syncState: string; syncMove: string; syncEvent: string; cameraCue: boolean;
};
export const emptyMatchSnapshot: MatchSnapshot = {
  fps: 0, frameMs: 0, playerX: 0, playerY: 0, playerZ: 0, playerYaw: 0, cpuX: 0, cpuY: 0, cpuZ: 0, cpuYaw: 0, playerMotion: 'idle', cpuMotion: 'idle', playerAnimation: '—', cpuAnimation: '—', playerBones: 0, cpuBones: 0, skins: 0, separation: 0, cameraMode: 'broadcast', cameraX: 0, cameraY: 0, cameraZ: 0, targetX: 0, targetZ: 0, loaded: false, grounded: true, drawCalls: 0, triangles: 0, playerHealth: 100, cpuHealth: 100, playerStamina: 100, cpuStamina: 100, playerMomentum: 0, cpuMomentum: 0, playerCombat: 'IDLE', cpuCombat: 'IDLE', combatEvent: '', syncState: 'FREE', syncMove: '', syncEvent: '', cameraCue: false,
};
