...
const source = new Image(); source.src = '/character-references/rhea/face-front.png'; await source.decode();
...
function pixels(now: number) {
  ...
  gl.readPixels(270,580,180,160,gl.RGBA,gl.UNSIGNED_BYTE,data); return data;
}
